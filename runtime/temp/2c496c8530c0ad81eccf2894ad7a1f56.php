<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpstudy_pro\WWW\nianka_v2\public/../application/index\view\index\children.html";i:1588068778;s:81:"D:\phpstudy_pro\WWW\nianka_v2\public/../application/index\view\common\header.html";i:1587964544;s:82:"D:\phpstudy_pro\WWW\nianka_v2\public/../application/index\view\common\daohang.html";i:1587966119;s:81:"D:\phpstudy_pro\WWW\nianka_v2\public/../application/index\view\common\footer.html";i:1587707976;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
      <meta charset="utf-8">
...
<ul class="layui-nav layui-nav-tree noprint" lay-filter="demo" id="layui-left" style="width:16%;">
  <li class="layui-nav-item layui-nav-itemed" >
    ...
    <dd id="addfaces"><a href="addfaces.html">添加人脸</a></dd>
...
<div class="right layui-main layui-tab layui-tab-brief" style="margin-top:0;">
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md5">
                        <div class="site-groupphoto-flow">
                            ...
                            <button type="button" class="layui-btn snap" data-id="groupphoto" style="margin-top:10px;">点击拍制卡照</button>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md5" style="text-align: center;">
                        <div class="site-photo-flow">
                            ...
                            <canvas style="display: none;margin:auto;margin-bottom:2px;">预览</canvas>
                            <button type="button" class="layui-btn snap" data-id="photo1" style="margin-top:10px;">点击拍摄个人照</button>
                        </div>
                    </div>
                    <div class="layui-col-md5">
                        ...
                        <div class="layui-row" style="margin-bottom: 15px;">
                                ...
                                <div class="layui-col-md6">
                                    <input name="shenfenz" id="shenfenz" lay-verify="identity" placeholder=""
                                           autocomplete="off"
    ...
    <div id="bott" class="layui-row" style="margin-bottom:30px; margin-top:50px;">
        ...
        <div class="layui-col-md3">
            <button class="layui-btn layui-btn-big layui-btn-radius" lay-submit="" lay-filter="demo1" id="btnSend">
                保存
            </button>
        </div>
...
<script src="__STATIC__/js/layer-v3.1.1/layer/layer.js"></script>
<script>
    // const width = 200;
    // const height = 200;
    ...
    function drawCanvasImage() {
        const photo = xcanvas.siblings("button").attr("data-id");
        ...
        $.post('<?php echo url("api/verifyfaces"); ?>', {faces: imgStr}, function (data) {
