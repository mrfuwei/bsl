            ...
            <div class="layui-form-item">
                <div class="layui-col-md5">
                    <div class="site-photo-flow">
                        <img src="/nianka_v2/public<?php echo $vo['photo']; ?>" alt="">
                    </div>
                </div>
