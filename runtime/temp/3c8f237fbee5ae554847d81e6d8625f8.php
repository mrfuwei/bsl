        ...
        <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-form" style="margin-top:40px;">
                ...
                <table class="layui-table" id="myTable" style="table-layout:fixed" >
                    ...
                    <?php if(is_array($versionInfo) || $versionInfo instanceof \think\Collection || $versionInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $versionInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$version): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo $version['id']; ?></td>
                        <td><?php echo $version['download_link']; ?></td>
                        <td><?php echo $version['version_no']; ?></td>
                        <td><?php switch($version['is_force']): case "0": ?>否<?php break; case "1": ?>是<?php break; default: ?>未知<?php endswitch; ?></td>
                        <td><?php echo $version['remarks']; ?></td>
                        <td><?php echo $version['create_at']; ?></td>
                    </tr>
                ...
                <!--分页-->
                <div><?php echo $versionInfo->render(); ?></div>
