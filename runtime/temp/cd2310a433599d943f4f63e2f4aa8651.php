  ...
  <div class="layui-frome">
    ...
    <!--startprint1-->
      <div style="width:197px;height:auto;color:#000;" id="page1">
            <img style="width:55%;height:115px;" src="data:image/jpeg;base64,<?php echo $clubxx['PHOTO']; ?>">
