            ...
            <div class="layui-form-item">
                <div class="layui-col-md5">
                    <div class="site-groupphoto-flow">
                        ...
                        <img src="/nianka_v2/public<?php echo $clubxx['photo']; ?>">
                    ...
                    <div class="layui-row" style="margin:50px auto 50px;">
                        ...
                        <div class="layui-col-md6">
                            <select name="card_type" lay-verify="required">
                                <option value="1" <?php if($clubxx['card_type'] == 1): ?>selected<?php endif; ?>>工作日卡</option>
                                <option value="2" <?php if($clubxx['card_type'] == 2): ?>selected<?php endif; ?>>非节假日卡</option>
                                <option value="3" <?php if($clubxx['card_type'] == 3): ?>selected<?php endif; ?>>畅玩卡</option>
            ...
            <div class="layui-form-item" style="margin-bottom:80px;">
                ...
                <div class="layui-col-md5">
                    ...
                    <div class="layui-row" style="margin-bottom: 15px;margin-top:25px;">
                        ...
                        <div class="layui-col-md7">
                            <input  class="layui-input" type="hidden" name="is_get_features[]"  value="<?php echo $vo['is_get_features']; ?>">
                            <input  class="layui-input"  disabled value="<?php if($vo['is_get_features'] == 1): ?>提取成功<?php else: ?>提取失败<?php endif; ?>">
